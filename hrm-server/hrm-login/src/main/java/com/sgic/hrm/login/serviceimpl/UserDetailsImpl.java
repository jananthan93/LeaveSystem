...
public class UserDetailsImpl implements UserDetails {
	...
	public UserDetailsImpl(Integer id, User user, String username, String email, String password,
	...
	public static UserDetailsImpl build(Login login) {
		...
		return new UserDetailsImpl(login.getId(), login.getUser(), login.getUsername(), login.getEmail(),
	...
	public boolean equals(Object o) {
		...
		UserDetailsImpl login = (UserDetailsImpl) o;
